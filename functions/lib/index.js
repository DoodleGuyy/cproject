...
exports.handleUserDisconnect = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
admin.initializeApp();
exports.handleUserDisconnect = functions.database
    ...
    try {
        ...
        if (!(data === null || data === void 0 ? void 0 : data.partecipanti) || data.partecipanti.length === 0) {
